...
const summary =
  score >= 8
    ...
    : 'The workspace still needs stronger literature grounding, sharper architecture, or more rigorous experiments.'

const recommendation =
  metrics.literature_review !== undefined && metrics.literature_review < 0.9
    ? 'Ground the project in cited memory-agent papers and benchmarks before tightening reward formulas.'
    : metrics.benchmark_map !== undefined && metrics.benchmark_map < 0.9
      ? 'Map concrete benchmarks and paper-defined metrics before adding more architecture detail.'
